  ...
  return (
    <section className="py-16 px-4 md:px-12 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-6xl mx-auto">
          ...
          {deployPlatforms.map((platform, idx) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="mb-8">
                  <h4 className="text-lg font-semibold text-gray-700 mb-4">Recursos principais:</h4>
                    ...
                    {platform.workflow.map((step, stepIdx) => (
                      <React.Fragment key={stepIdx}>
                        ...
                        >
                          ...
                          <span className="text-xs mt-2 text-gray-600 font-medium">{step}</span>
                        </motion.div>
                        {stepIdx < platform.workflow.length - 1 && (
                          ...
                          >
                            <div className={`h-full bg-gradient-to-r ${platform.color} transition-all duration-1000`}></div>
                          </motion.div>
                        )}
                      </React.Fragment>
                    ))}
        ...
        >
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-100 to-cyan-100 rounded-full text-sm text-gray-700">
            <span>⚡</span>
